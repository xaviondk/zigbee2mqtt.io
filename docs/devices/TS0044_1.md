...
### Battery
Uses a CR2430. 
(2xAAA models seem to exist)

### Pairing
Press the lower left button for approx. 10 seconds to pair. All 4 button LEDs will blink.

(2xAAA model requires 5-10 sec press on button 1 to enter pairing mode)
...
(2xAAA version seem to only expose single click option for each of the 4 buttons)
